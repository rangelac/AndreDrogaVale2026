# Trabalho eficiente neste projeto

- Leia `MEMORIA.md` primeiro; abra apenas os trechos e arquivos ligados ao pedido atual.
- Use `rg -n` com contexto curto. Evite despejar HTML/CSS minificado ou históricos inteiros.
- Reaproveite fontes, decisões e ferramentas já verificadas; consulte novamente fatos mutáveis quando atualizar seu status.
- Modifique o componente solicitado. Não redesenhe outras áreas nem adicione funcionalidades sem necessidade.
...
- Não altere modelo, configurações globais ou plugins sem necessidade. Nenhuma economia percentual é garantida.

Estas instruções se aplicam a este repositório, não aos outros projetos do usuário.
